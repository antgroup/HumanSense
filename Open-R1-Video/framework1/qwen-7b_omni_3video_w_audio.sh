export WANDB_PROJECT=stage3
export WANDB_NAME=stage3
...
dataset_json_file="data/merged_video_w_audio.json"
...
checkpoint_dir="experiments/stage2/stage2/checkpoint-119"
