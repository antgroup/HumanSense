import sys
sys.path.append('/path/to/InternLM-XComposer/InternLM-XComposer-2.5-OmniLive/internlm-xcomposer2d5-ol-7b')
sys.path.append('/path/to/InternLM-XComposer/InternLM-XComposer-2.5-OmniLive/internlm-xcomposer2d5-ol-7b/memory')
...
class IXC25omniLive(Model):
    def __init__(self):
        IXC25omniLive_Init()

    def Run(self, question_info):
        return IXC25omniLive_Run(question_info)
    
    def name(self):
        return "IXC25omniLive"

def IXC25omniLive_Init():
    global vs_model, args, image_processor ,vs_tokenizer, ixc_model
    ...
    ixc_model_path="internlm-xcomposer2d5-ol-7b",
    max_frame=32,
    vs_thresh=0.2
    )
...
def IXC25omniLive_Run(question_info):
